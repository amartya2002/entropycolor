...
<div className="max-w-7xl mx-auto px-5 mt-20 lg:mt-20 pb-12 sm:px-6 lg:px-8 ">
  <div className="max-w-2xl mx-auto">
    
    <div className="flex justify-between items-center mb-6">
      <div className="flex w-full sm:items-center gap-x-5 sm:gap-x-3">
        <div className="flex-shrink-0">
          <Image className="h-12 w-12 rounded-full" src={dp}alt="Image Description"/>
        </div>
    ...
    <div className="space-y-5 md:space-y-8">
      ...
      <p className="text-lg text-gray-800 dark:text-gray-200">Hello <a className="text-blue-600 decoration-2 hover:underline font-medium" href="#">Hello</a>, Hello</p>

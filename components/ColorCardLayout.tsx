...
const ColorCardLayout = () => (
  <div className="mx-4 max-w-7xl md:px-12 lg:px-32 ">
    ...
    <div className=" flex justify-center">
      <div className=" no-scrollbar h-[30rem] overflow-y-scroll rounded-2xl border-4 border-zinc-100 dark:border-zinc-700 dark:bg-transparent ">
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5  p-2 ">

...
const ColorCardLayout = () => (
    <div className='max-w-7xl mx-8 md:px-12 lg:px-32 '>
        <p className=' text-ceter font-medium text-2xl  text-gray-800 pb-8 dark:text-zinc-200  '>Some shades for <span className='text-blue-500 block dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-t from-zinc-500 to-zinc-200 '>your new project.</span></p>

...
export default function NavBadge() {
  return (
    <section>
        <a href='blogs/v1' className="inline-flex flex-nowrap items-center bg-white border border-gray-200 rounded-full py-1 px-2 dark:b-slate-900 dark:border-zinc-300">

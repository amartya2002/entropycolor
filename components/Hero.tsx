...
import ColorCardLayout from './ColorCardLayout' ///need types
      ...
      <section className=''>
        ...
        <div className="mx-auto h-full max-w-7xl px-8 py24 md:px-12 lg:px-32 l;g:py-32 mb-10">
          ...
          <div className="text-center">
            <p className="text-4xl font-semibol leading-tight lg:leding-tight tracking-tighter text-gray-800 dark:text-zinc-200 lg:text-7xl">
